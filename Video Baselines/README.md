...
Please note that, since different methods have varied input sizes, you need to refer to their source papers and change the MyDataset.py, utils.py, or MyLoss.py.
