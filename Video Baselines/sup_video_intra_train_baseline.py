...
if __name__ == '__main__':
    ...
    # my_model = PhysNet_padding_Encoder_Decoder_MAX()
    # my_model = MTTS_CAN()
        ...
        for iter_num in it:
            ...
            if (iter_num > 0) and (iter_num % 1000 == 0):
                ...
                for step, (data, bvp, HR_rel, spo, rf, resp, _, _, _, _, _, _, _) in tqdm(enumerate(tgt_loader)):
                    ...
                    # Resp_ALL.extend(Resp_rel.data.cpu().numpy())
                    # Resp_PR_ALL.extend(Resp_pre.data.cpu().numpy())
