...
class MTTS_CAN(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
                 dropout_rate2=0.5, pool_size=(2, 2), nb_dense=128, frame_depth=128):
    ...
    def forward(self, inputs, params=None):
        ...
        # return out_y, out_r
        A,B = out_y.shape
        out_y = out_y.view(N,A//N)
        A, B = out_r.shape
        out_r = out_r.view(N, A // N)

        # return None, out_y, out_r, None, None
        return out_y, None, None, None,out_r