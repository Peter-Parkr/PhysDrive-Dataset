...
class BigSmall(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3,
        ...
        # self.big_conv1 = nn.Conv2d(self.in_channels, self.nb_filters1, kernel_size=self.kernel_size, padding=(1, 1),
        #                            bias=True)
        ...
        self.hr = nn.Linear(5184, 1, bias=True)
        ...
        self.rr = nn.Linear(5184, 1, bias=True)
    ...
    def forward(self, inputs, params=None):
        ...
        share1 = share1.view(params[0], params[1], -1)
        share1 = share1.mean(dim=1)  # average over time

        hr = self.hr(share1)
        rr = self.rr(share1)

        return bvp_out, resp_out, hr, rr
